export default function LoadingVideo() {
  return (
    <div className="max-w-[100%] lg:max-w-[70%] lg:min-w-[50%] md:mx-5 md:mr-8 md:mb-4 mb-3 ">
      <div className="flex bg-cover w-[100%] dark:text-white text-xl text-center justify-center items-center bg-gray-400 dark:bg-gray-700" style={{ aspectRatio: 8.7 / 4.9 }}></div>

export default function ButtonTrigerOpen({ isOpen, callback }) {

  return (
    <button onClick={() => callback(!isOpen)} className="text-white bg-cyan-500 dark:bg-cyan-400 aspect-square hover:scale-[1.1] active:scale-[1.1] transition-all duration-300 ease-in-out font-medium rounded-full text-sm p-2 outline-none shadow-xl shadow-gray-700/50">
